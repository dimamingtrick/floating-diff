 ...
 * left or right edge; shrunk and moved so it stays inside the window.
 */
export function placePopup(anchor: Rect, size: Size, view: Size, align: 'left' | 'right' = 'left'): Placement {
	...
	const start = align === 'right' ? anchor.right - maxWidth : anchor.left;
	return {
